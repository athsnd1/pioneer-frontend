...
export default function Menu({ closeMenu }: Props) {
  ...
  return (
    <div className="bg-white border-1 border-gray-300 rounded-lg shadow-sm w-[200px] h-max fixed top-18 right-1 text-sm">
        ...
        <div className="flex flex-col items-start gap-0.5 text-sm w-full">
            ...
            <div className="flex flex-col items-start  w-full cursor-pointer pl-4 pt-2.5 pb-2 pr-4 hover:bg-gray-50">
                ...
                <div className="flex items-center gap-1 justify-between w-full pr-2.25 text-blue-500" 
        ...
        <div className="text-red-700 text-sm flex items-center gap-1 font-sora p-2 pl-4 cursor-pointer rounded-b-lg hover:bg-red-50 transition-all" onClick={() => { logout(); navigate("/login"); closeMenu(); }}>
